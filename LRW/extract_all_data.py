...
def lrw_move_files_based_on_txt(extracted_directory, dataset_names, data_splits_dir, root_path):
    ...
    # Process each .txt file for dataset directories
    for word in os.listdir(extracted_directory):
        word_dir_path = os.path.join(extracted_directory, word)
...
# parts = ['lrw-v1-partaa']
extracted_directory = './LRW/lipread_mp4'
# data_splits_dir = './LRS2/data_splits'
data_splits_dir = './LRW/data_splits'
root_path = './LRW/'
